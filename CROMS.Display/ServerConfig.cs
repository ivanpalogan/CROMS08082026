...
namespace CROMS.Display
{
    ...
    /// string with it. So the display board automatically points at the same
    /// server the staff app was configured with — set the IP once, all three
    /// apps follow. If the file isn't there, the App.config value is used as-is.
    /// </summary>
