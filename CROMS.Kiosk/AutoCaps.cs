...
{
    /// <summary>
    /// Auto-capitalizes the first letter of each word in a name field as the client types
    /// ("john" -&gt; "John", "dela cruz" -&gt; "Dela Cruz"). Only a lowercase letter sitting at the
    /// start of a word is changed — everything else the client typed (including an already-
    /// capitalized letter, or a letter mid-word) is left exactly as they wrote it, so this
    /// cannot mangle a name like "McDonald" or "O'Brien".
    /// </summary>
    internal static class AutoCaps
    {
